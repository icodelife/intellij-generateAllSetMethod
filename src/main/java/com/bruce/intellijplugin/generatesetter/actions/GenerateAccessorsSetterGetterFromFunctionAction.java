 ...
 * @author codelife
 */
public class GenerateAccessorsSetterGetterFromFunctionAction extends GenerateAllSetterBase {
    public GenerateAccessorsSetterGetterFromFunctionAction() {
    ...
    public String getText() {
        return CommonConstants.GENERATE_ACCESSORS_CONVERTER_FROM_METHOD;
    }
}
